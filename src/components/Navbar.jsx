...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      <div tabIndex={0} role="button" className={`lg:hidden text-white ${pathname !== '/' && 'text-black'}`}>
        <svg
    ...
    <a className={`text-xl text-white font-bold ml-10 lg:ml-0 ${pathname !== '/' && 'text-black'}`}>Gadget Heaven</a>
  </div>
